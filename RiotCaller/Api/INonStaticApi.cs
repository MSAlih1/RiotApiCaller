...
namespace RiotCaller.Api
{
    public interface INonStaticApi
    {
        ...
        CurrentGame GetCurrentGame(string summonerName, region region, bool useCaching = false);
        CurrentGame GetCurrentGame(long summonerId, region region, bool useCaching = false);
        ...
        MatchList GetMatchList(long summonerId, region region, List<long> championIds = null, List<queue> queue = null, List<season> seasons = null, DateTime? beginTime = default(DateTime?), DateTime? endTime = default(DateTime?), int? beginIndex = default(int?), int? endIndex = default(int?), bool useCaching = false);
